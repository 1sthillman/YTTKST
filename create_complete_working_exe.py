...
"""
    ...
    # Lisans kodlarını ve kanal listesini içeren bilgi dosyası oluştur
    license_info = """
YOUTUBE MEZAT YARDIMCISI - LİSANS BİLGİLERİ
...
Kullanım için yukarıdaki bilgileri programa girin.
"""

    with open(os.path.join(final_dir, "LISANS_BILGILERI.txt"), "w", encoding="utf-8") as f:
        f.write(license_info)
    print(f"[+] LISANS_BILGILERI.txt dosyası oluşturuldu.")
    ...
    print("\n[+] Tam çalışan EXE paketi oluşturma tamamlandı!")
...
def main():
    print("======== YouTube Mezat Yardımcısı - TAM ÇALIŞAN EXE OLUŞTURMA ========")
    print("=======================================================")
    ...
    if create_exe_package():
        print("\n[+] Tam çalışan EXE paketi başarıyla oluşturuldu.")
