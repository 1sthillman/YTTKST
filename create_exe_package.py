...
def create_exe_package():
    """mezaxx.py dosyasından EXE paketi oluşturur"""
    print("======== YouTube Mezat Yardimcisi - EXE OLUSTURUCU ========")
    print("============================================================")
    ...
    required_files = ["mezaxx.py", "license_codes.json", "supabase_config.json", "requirements.txt"]
    ...
    # Paket adı oluştur
    package_name = f"YOUTUBE_MEZAT_YARDIMCISI_EXE_v3.0_{datetime.datetime.now().strftime('%d%m%Y')}"
